...
## 自我评价
9年数通、通信行业背景；丰富的软件开发、设计经验；乐于创新、挑战；良好的团队领导能力，乐群、协作；能在压力下完成工作。  

___________________________

## 工作经历
- 2016.6 - 至今 [1年8个月] 华为技术有限公司 云计算网络开发部/云计算解决方案部
...
## 专业技能
- 10年电信、数通、云计算领域软件开发、测试经验；丰富的故障定位、解决经验；熟悉软件开发流程；
...
负责性能优化工作，通过拆分消息处理流程提高并发处理速度，从2000caps提高到8000caps。  
