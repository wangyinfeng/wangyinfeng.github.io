...
## 自我评价
9+年云计算、数通、通信行业背景；丰富的软件开发、设计经验；良好的英语沟通能力与跨文化交流经验；乐于创新、挑战，乐于接受新知识；良好的团队协作能力，乐群、协作；能在压力下完成工作。  
...
- 2008.7 - 2012.2  [3年6个月] 南京中兴通讯有限公司
...
## 专业技能
- 9+年云计算、电信、数通领域软件开发、测试经验；丰富的故障定位、解决经验；熟悉软件开发流程；
- 熟悉云计算网络技术，特别是虚拟化网络技术，DPDK等数据面加速技术；
...
SIU(Signaling Interface Unit) 是基于中兴MSG9000 硬件平台及 VxWorks操作系统的信令消息处理平台。  
    - 主要工作  
主要负责GSM短消息信令需求开发，涉及3GPP MAP/TCAP/SCCP协议簇。  

- SSIU短消息信令平台  
    - 项目介绍  
SSIU(Server Signaling Interface Unit) 是基于X86刀片服务器及Linux操作系统的新一代低成本通用信令平台。   
    - 主要工作  
主要负责从SIU-V3平台移植信令协议到新平台，以及相关需求开发，问题定位，性能优化，客户POC支持等。涉及Sigtran协议簇，包括SCTP(RFC2960)，M3UA (RFC3332/RFC4666)。  

- SIU-V4 短消息信令平台  
    - 项目介绍  
SIU-V4 是基于中兴自研通用刀片服务器(USAP1000) 及Linux 操作系统的下一代信令平台。  
    - 主要工作  
主要负责从SIU-V3平台移植信令协议到SIU-V4，以及相关需求开发，问题定位，性能优化，涉及MAP/TCAP/SCCP协议簇。  
