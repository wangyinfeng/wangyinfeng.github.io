...
- Good theoretical knowledge and rich development experience about switcher/router software; rich experience about BCM SDK development;
...
I was responsible for the routing and firewall modules, wrote scripts (Python and Shell) to do automatically testing and deploying.  
- Customer support and POC(Proof Of Concept) demonstration  
 - POC for Beijing Unicom;  
